        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          {formData.imageUrls.length > 0 &&
            formData.imageUrls.map((url,index) => (
              <div key={url} className="flex justify-between p-3 mx-auto border items-center gap-6">
                <img
                  src={url}
                  alt="listing image"
                  className="w-40 h-40 object-contain rounded-lg"
                />
                <button onClick={() => handelRemoveImage(index)} className="p-1 bg-red-700 text-white rounded-lg uppercase hover:opacity-75 ">
                  Delete
                </button>
              </div>
            ))}
